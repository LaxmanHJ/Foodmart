...
<?php
    ...
    if (isset($_POST["add"]) && !empty($_SESSION["login"])){
        if (isset($_SESSION["cart"])){
            ...
            //$str0 = implode(",", $item_array_id);
           // echo "iddddd".$str0."  ".$_SESSION["cart"];
           //$str5 = implode(",", $_SESSION["cart"]);
           //echo "isisis".$str5;
            if (!in_array($_GET["id"],$item_array_id)){ 
               ...
               //
               $str = implode(",", $_SESSION["cart"][0]);
               echo "iffffffffff".$count."".$str."     ";
              ...
              $item_array = array(
                ...
                'item_name' => $_POST["hidden_name"],
                'product_price' => $_POST["hidden_price"],
                'item_quantity' => $_POST["quantity"]+$c,
                'click'=>$c,
            );
