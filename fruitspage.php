          ...
          <div class="container-fluid">
            ...
            <div   class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="active">Fruits<span class="caret"></span></a>
        ...
        <?php
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <form method="post" action="fruitspage.php?action=add&id=<?php echo $row["id"]; ?>">
                    ...
                    <div class="panel panel-default text-center">
                        ...
                        <div class="panel-body">
                          <img class="gallery" src="<?php echo $row["fimage"]; ?>"  alt="..." width="100%" height="175px">
                  
                        </div>
                        <div class="panel-footer">
                          <h3>₹<?php echo $row["fprice"]; ?></h3>
                          <h4>per Dozon</h4>
